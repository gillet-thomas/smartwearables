   ...
   Visualizer to visualize SMPL reconstruction output from HMR family (HMR, SPIN, EFT)
    ...
    def visualize(self,
        ...
        if pred_mesh_list is not None:
            ...
            res_img = rend_img                                                  # ONLY RETURN THE GENERATED AVATAR
    ...
    def __render_pred_verts(self, img_original, pred_mesh_list):
        ...
        if self.rendererType =="opengl_gui":
            ...
            self._visualize_screenless_naive(pred_mesh_list_offset, img_original=res_img)  # GOES HERE
    ...
    def _visualize_screenless_naive(self, meshList, skelList=None, body_bbox_list=None, img_original=None, show_side = False, vis=False):
        ...
        self.renderer.setWindowSize(img_original.shape[1], img_original.shape[0])
        self.renderer.setBackgroundTexture(img_original)
        self.renderer.setViewportSize(img_original.shape[1], img_original.shape[0])
